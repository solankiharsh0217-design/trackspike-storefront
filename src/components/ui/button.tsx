    ...
    return (
      <button
        ...
        className={cn(
          ...
          {
            'bg-accent text-white hover:bg-accent-hover hover:shadow-gold active:scale-[0.98]': variant === 'primary',
            'bg-primary text-white hover:bg-primary-hover active:scale-[0.98]': variant === 'secondary',
